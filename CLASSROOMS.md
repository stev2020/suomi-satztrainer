...
Aktivierung: zuerst `supabase/migrations/20260914063059_classroom_teacher_roles.sql` anwenden, danach das Frontend veröffentlichen. Die Migration ist noch nicht auf dem Live-Projekt angewendet.
