...
Level 2 (397 Sätze) lag weit unter Level 3 (1.570), Level 6 hatte nur 19 Sätze. Aus den Tatoeba-Exporten vom 25. September 2026 (`fin_sentences_detailed`, `deu_sentences_detailed`, `fin-deu_links`) wurden alle finnischen Sätze mit direkter deutscher Übersetzung gesammelt, die weder im aktiven Bestand noch im Archiv stehen (ID und normalisierter Text): 13.037 Paare. `level_import.py` schätzte 1.051 davon als Level 1/2 und 403 als Level 6 ein.

Jeder dieser 1.454 Kandidaten wurde von KI geprüft (`sources/level-fill-instructions.md`): finnische Korrektheit und Idiomatik, deutsche Übersetzung (Anrede, Bedeutung, Grammatik; falsche Varianten werden weggelassen), Level (Level 2 ohne Vergangenheit, Konditional, Nebensätze und Umgangssprache; Level 6 nur wirklich anspruchsvolle Sätze), Eignung (keine anstößigen, politischen oder stereotypen Inhalte, keine Fragmente und Beinahe-Dubletten) und Lernpfad-Thema. Ergebnis: 744 von 1.051 bzw. 145 von 403 behalten; textgleiche Sätze verschiedener Beitragender und zwei Fast-Dubletten bestehender Sätze wurden entfernt (`scripts/find-sentence-duplicates.mjs`). Jeder behaltene Satz hat 1–3 Grammatikhinweise (`sources/grammar-import-specific.tsv`) und die Wortanalyse.

- **Neu:** Level 1 +192 (492), **Level 2 +544 (941)**, **Level 6 +145 (164)**; 5.335 aktive Sätze. Keine Aufnahmen; Text, Autorinnen/Autoren und Lizenz (CC BY 2.0 FR) bleiben erhalten. Bisherige Sätze, Levels und Lernstände sind unverändert.
