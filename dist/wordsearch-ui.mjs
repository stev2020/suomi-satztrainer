...
export function mountSearch(container,puzzle,onComplete){
 ...
 container.querySelector('.search-instructions').append(' Auf dem Smartphone: Mit einem Finger Wörter markieren, mit zwei Fingern das Rätsel seitlich verschieben.');
